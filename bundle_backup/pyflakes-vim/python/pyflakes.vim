...
au BufWritePost <buffer> call s:PyflakesUpdateAndShow()
...
if !exists("*s:PyflakesUpdateAndShow")
	function s:PyflakesUpdateAndShow()
		call s:PyflakesUpdate()
		if b:matched != []
...
if !exists(":PyflakesUpdateAndShow")
  command PyflakesUpdateAndShow :call s:PyflakesUpdateAndShow()
endif
